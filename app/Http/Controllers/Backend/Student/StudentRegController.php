...
class StudentRegController extends Controller
{
    public function StudentRegView(){
    	...
    	$data['group_id'] = StudentClass::orderBy('id','desc')->first()->id;
    	$data['shift_id'] = StudentClass::orderBy('id','desc')->first()->id;
    	// dd($data['class_id']);
    ...
    public function StudentClassYearWise(Request $request){
    	...
    	$data['allData'] = AssignStudent::where('shift_id',$data['shift_id'])->where('group_id',$data['group_id'])->where('year_id',$request->year_id)->where('class_id',$request->class_id)->get();
    	return view('backend.student.student_reg.student_view',$data);
    ...
    public function StudentAdmissionRegStore(Request $request){
		DB::transaction(function() use($request){
			$checkYear = StudentYear::find($request->year_id)->name;
			$student = User::where('usertype','Student')->orderBy('id','DESC')->first();
			...
			$af = AdmissionForm::find($request->admission_id);
    	...
    	return redirect()->route('admission.view')->with($notification);
