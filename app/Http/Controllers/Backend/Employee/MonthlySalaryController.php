  ...
  $stringdate = strval($date);
    	...
    	//  dd($allStudent);
    	 ...
    	 foreach ($data as $key => $attend) {
			...
			$bonous = AccountEmployeeSalary::where('date',$stringdate)->where('employee_id',$attend->employee_id)->get();
    	 	...
    	 	$html[$key]['tdsource'] .='<td>'.$bonous[0]['bonous_amount'].'</td>';
    	 	$html[$key]['tdsource'] .='<td>'.$bonous[0]['bonous_name'].'</td>';
