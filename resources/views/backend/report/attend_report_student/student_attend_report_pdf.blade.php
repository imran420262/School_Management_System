...
<p> <b>Student Attendance Report </b> </p>
 ...
 <br> <br>
 <strong>Student Name : </strong> {{ $allData[0]['student']['name'] }}, <strong> ID No : </strong>{{ $allData[0]['student']['id_no'] }}, <strong> Month : </strong> {{ $month }}
 <br> <br>
<table id="customers">
