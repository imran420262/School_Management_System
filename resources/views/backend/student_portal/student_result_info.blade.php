                ...
                <div class="col-12">
                  <div class="box bb-3 border-warning">
                    <div class="box-header">
                        <h4 class="box-title">Your <strong>Marks</strong></h4>                        
                    </div>
...
@endif
                      ...
                      <div class="btn btn-rounded btn-primary">
                        <a href="{{ route('student.result.info.view') }}">Back</a>
                        {{-- <a href="{{ route('student.result.download') }}">Download</a> --}}
                      </div>
                      <br><br>

                      <form method="post" action="{{ route('student.result.download') }}">
                        @csrf
											  <input type="submit" class="btn btn-rounded btn-info mb-5" value="Print Result">

                        <input type="text" name="exam_type_id" value="{{ $exam_type_id }}" style="visibility: hidden;">
                      </form>
