	...
	<div class="col-md-4">
	 ...
	 <input type="text" name="address" class="form-control" required="" value="{{ $editData->address }}" > 
			 ...
			 <div class="col-md-4">
				...
				<div class="form-group">
			  <h5>Educational Qualification <span class="text-danger">*</span></h5>
			  <div class="controls">
		   <input type="text" name="edu_qualification" value="{{ $editData->edu_qualification }}" class="form-control" required="" > 
			</div>		 
			</div>
		  ...
		  <div class="col-md-4">
			  ...
			  <div class="controls">
		   <input type="text" name="edu_institute" value="{{ $editData->edu_institute }}" class="form-control" required="" > 
			</div>		 
			</div>
		 ...
		 <div class="box-header with-border">
			...
			<div class="row">
				<div class="col-md-4">
				  ...
				  <h5>Facebook Link</h5>
				  <div class="controls">
			   <input type="text" name="facebook_link" value="{{ $editData->faecbook_link }}" class="form-control"> 
				</div>		 
				</div>
			  ...
			  <div class="col-md-4">
				  ...
				  <div class="controls">
			   <input type="text" name="instagram_link" value="{{ $editData->instagram_link }}" class="form-control"> 
				</div>		 
				</div>
			  ...
			  <div class="col-md-4">
				  ...
				  <h5>Twitter Link</h5>
				  <div class="controls">
			   <input type="text" name="twitter_link" value="{{ $editData->twitter_link }}" class="form-control"> 
				</div>		 
				</div>
