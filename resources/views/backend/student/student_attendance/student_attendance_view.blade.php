								...
								<div class="row">
									<div class="col-12">
										...
										<div class="text-xs-right">
											<input type="submit" name="action" class="btn btn-rounded btn-info mb-5" value="Add Attendance">
											<input type="submit" name="action" class="btn btn-rounded btn-info mb-5" value="View Attendance">
										</div>
									</div> <!-- End of col-12 -->
								</div> <!-- End of row -->
							</form> <!-- End of form -->
