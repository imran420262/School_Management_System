							...
							<form method="post" action="{{ route('store.student.attendance') }}">
								...
								<div class="row">
									<div class="col-12">	
										...
										<input  name="subject_id" id="subject_id" hidden value="{{ $subject_id }}">
										<input name="shift_id" hidden value="{{ $shift_id}}">
										<div class="row">
											<div class="col-md-12">
												<table class="table table-bordered table-striped" style="width: 100%">
													...
													<tbody>
														...
														<tr id="{{$student->student_id}}" class="text-center">
															...
															<input type="hidden" name="student_school_id[]" value="{{ $student['student']['id_no'] }}">
															<td>{{ $key+1  }}</td>
